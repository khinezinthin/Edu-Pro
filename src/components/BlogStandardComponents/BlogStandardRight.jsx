  ...
  return (
    <div className=" w-full flex  justify-center flex-wrap flex-col lg:flex-row ">
      <div className="lg:w-[50%]  md:w-[70%] w-full  m-auto flex flex-col gap-7 justify-center items-center pb-10">
        <div className="mx-auto  shadow w-full p-3 flex flex-col gap-4 lg:gap-7 md:gap-5   overflow-hidden bg-[--color-shape]">
          ...
          <div className="flex flex-col  gap-5">
            <div className=" flex justify-between items-center p-2 ">
              <div className="  flex justify-between items-center gap-2 hoverBtn ">
                ...
                <p className=" text-[--color-extra01] hoverEl">Social Media</p>
              </div>
              <div className="  flex justify-between items-center gap-2 hoverBtn">
            ...
            <div className=" flex items-center flex-col gap-4 md:gap-6  lg:gap-10">
              ...
              <p className=" line-clamp-3">
                ...
                consectetur adipisicing elit. Eaque cupiditate delectus tempore
                labore suscipit cumque. Lorem ipsum dolor sit amet, consectetur
                adipisicing elit. Nisi laudantium dolores quis natus! Ad tempora
                nihil reiciendis asperiores porro aut, perferendis, eveniet
                quaerat provident deleniti minus debitis cum soluta. Illum?
              </p>
